...
class timer_data:
    ...
    def add_timer(self, author_id, business_type, resupply_time):
        try:
            author_data = self.author_id
        except KeyError:
            author_data = {}

        author_data[business_type] = resupply_time
        self.data[author_id] = author_data
